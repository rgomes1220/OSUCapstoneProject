...
class EditProject extends React.Component {
  ...
  async componentDidMount() {
    try {
      ...
      // var project_id="492e61d0-e509-4e9b-96db-3148e015ca45"
      const response = await fetch(
        "https://v5yyja3u9i.execute-api.us-east-1.amazonaws.com/v0/get-project?project_id="+project_id
      );
      let responseJson = await response.json();
      console.log(responseJson)
      this.setState(
        {
            updating_project_id:project_id,
            name: responseJson.Item.name,
            description: responseJson.Item.description,
            picture: responseJson.Item.picture,
            team: responseJson.Item.team,
            school: responseJson.Item.school,
            tech: responseJson.Item.tech,
            college: responseJson.Item.college,
            fileName: responseJson.Item.picture,
            boothNumber: responseJson.Item.booth_number,
            links: responseJson.Item.links,
            isLoading: false
        },
        function() {}
      );
  ...
  async handleSubmit(event) {
    ...
    let postData = {
      project_id:this.state.updating_project_id,
      ...
      booth_number: this.state.boothNumber,
      college: this.state.college,
      links: inputLinks
    };

    fetch(
      "https://v5yyja3u9i.execute-api.us-east-1.amazonaws.com/v0/update-project-details",
      {
        method: "PATCH",
